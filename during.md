...
Este documento indica cómo actuar durante un incidente de ciberseguridad en {{COMPANY_NAME}}. Está adaptado al Plan Director de Seguridad, a los activos críticos identificados y a los incidentes más probables para una asesoría que presta servicios a autónomos y PYMES.
...
Durante la evalúación se debe comprobar si el incidente afecta a algún activo priorizado en el Plan Director de Seguridad.
...
2. Si no responde en {{INCIDENT_COMMANDER_RESPONSE_SLA}}, asumirá el mando el adjunto o la persona capacitada disponible.
...
6. Evitar el correo corporativo principal si está afectado o se sospecha compromiso. Usar {{ALTERNATE_EMAIL}} cuando sea necesario.
...
2. Programar actualizaciónes cada {{UPDATE_FREQUENCY}} o antes si el IC lo decide.
...
* Las comunicaciones obligatorias han sido evalúadas.
