...
3. Revisar antes de la reunión:
   ...
   * Comunicaciones internas, externas y regulatorias realizadas.
...
5. **¿Se compartió correctamente la inteligencia del incidente?**
    ...
    * Confirmar que el TLP aplicado fue correcto y que no se compartieron datos personales, credenciales, secretos, contratos ni evidencias forenses sensibles.
    * Registrar el identificador del evento MISP, destinatarios/comunidades, fecha de publicación y responsable que autorizó el intercambio.
    * Añadir acciones correctivas si faltaron indicadores, hubo retrasos, errores de clasificación TLP o problemas de coordinación con SOC/CERT, proveedores o comunidades de confianza.
...
| Comunicaciones | Mensajes emitidos, destinatarios, tiempos y aprobaciones. | Comprobar coordinación interna, externa y regulatoria. |
